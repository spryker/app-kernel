 ...
 */
class AppConfigValidatorPlugin extends AbstractPlugin implements RequestValidatorPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFactory()->createAppConfigValidator()->validate($glueRequestTransfer);
    }
}
